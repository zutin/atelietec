    ...
    <div class="h-screen md:flex">
        ...
        <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
            <form class="bg-white" method="POST" action="{{ route('login') }}">
                ...
                <button type="submit" class="block w-full bg-blue-600 mt-4 py-2 rounded-2xl hover:bg-blue-700 active:bg-blue-500 text-white font-semibold mb-2">Login</button>
            </form>
        </div>
    </div>
