                ...
                <div class="overflow-x-auto">
                    ...
                    <form method="post" action="{{ route('noc.facilities.store') }}">
                        ...
                        <div class="overflow-hidden shadow sm:rounded-md">
                            ...
                            <div class="px-4 py-5 bg-white sm:p-6">
                                <label for="designation" class="block text-sm font-medium text-gray-700">Designação da unidade</label>
                                <input type="text" name="designation" id="designation" class="block w-full mt-1 rounded-md shadow-sm form-input"
                            ...
                            <div class="px-4 py-5 bg-white sm:p-6">
                                <label for="carrier_id" class="block text-sm font-medium text-gray-700">Operadora</label>
                                <select name="carrier_id" id="carrier_id" class="block w-full mt-1 rounded-md shadow-sm form-control">
                                    @foreach($carriers as $carrier)
                                        <option value="{{ $carrier->id }}" {{ old('carriers') == $carrier->id ? 'selected' : '' }}>
                                            {{ $carrier->name }}
                                        </option>
                                    @endforeach
                                </select>
