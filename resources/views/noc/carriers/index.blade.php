        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="overflow-x-auto">
                    <a href="#" class="flex p-2 m-4 items-center w-32 rounded-xl bg-green-600 ml-auto font-medium text-white hover:bg-green-700">
                        ...
                        @foreach($carriers as $carrier)
                            <tr>
                                ...
                                <td class="whitespace-nowrap px-4 py-2 space-x-2">
                                    ...
                                    <a href="#" class="inline-block rounded bg-red-600 px-4 py-2 font-medium text-white hover:bg-red-700">
