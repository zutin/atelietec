    ...
    <div class="mx-auto max-w-5xl px-4 py-2 sm:px-6 lg:px-8">
        ...
        <nav aria-label="Footer Nav" class="mt-2">
            <ul class="flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
                <li>
                    <a class="text-gray-700 transition hover:text-blue-700/75" href="/about">
                        Sobre
                    </a>
                </li>

                <li>
                    <a class="text-gray-700 transition hover:text-blue-700/75" href="/services">
                        Serviços
                    </a>
                </li>

                <li>
                    <a class="text-gray-700 transition hover:text-blue-700/75" href="/contact">
                        Contato
                    </a>
                </li>
